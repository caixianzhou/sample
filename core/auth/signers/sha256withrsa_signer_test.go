...
func TestSha256WithRSASigner_Sign(t *testing.T) {
	...
	privateKey1, err := utils.LoadPrivateKey("-----BEGIN PRIVATE KEY-----\\nuus/C/tNgxO00jsMtQifxhVL\n-----END PRIVATE KEY-----")
	require.NoError(t, err)
	type args struct {
		mchID      string
		certSerial string
...
func TestMidasBuyVerifier_Algorithm(t *testing.T) {
	privateKey, err := utils.LoadPrivateKey(testingKey(testPrivateKeyStr))
	require.NoError(t, err)
